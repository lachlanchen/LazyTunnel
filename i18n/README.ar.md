...
## خادم ترحيل واحد وحسابات منفصلة

يمكن استخدام النواة بترخيص MIT لأجهزتك الخاصة أو لبناء خدمة بحسابات مستقلة. يضيف CLI 0.3.0 تسجيل الدخول بمفتاح أو كلمة مرور، ودعوات تتضمن مفتاح خادم مثبتًا، وتسجيل الأجهزة وإلغاء وصولها بواسطة مالكها فقط. لكل حساب قائمة أجهزته وصلاحيات SSH الخاصة به. تبقى مجموعات الأجهزة الحالية كما هي حتى إجراء ترقية صريحة.

بعد تلقي دعوة من مسؤول الخادم:
...
[إعداد الحسابات والعزل والحدود والترحيل](../docs/accounts.md).
